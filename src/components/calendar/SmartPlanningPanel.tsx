    ...
    <div className="space-y-4 p-4 text-sm">
      ...
      <section className="space-y-2 rounded-md border border-[#323234] bg-[#262627] p-3">
        ...
        {parsedTasks.length > 0 && (
          <div className="needt-panel-depth space-y-1 rounded-md border border-[var(--border-control)] p-2">
          ...
          {todayEnergy.length > 0 ? (
            todayEnergy.map((window) => (
              <div
                ...
                className="needt-panel-depth flex items-center justify-between rounded-md px-2 py-1"
              >
                <span>
      ...
      <section className="space-y-2 rounded-md border border-[#323234] bg-[#262627] p-3">
        ...
        <div className="needt-panel-depth rounded-md p-2 text-xs text-[var(--text-secondary)]">
      ...
      <section className="space-y-2 rounded-md border border-[#323234] bg-[#262627] p-3">
        ...
        {calibration?.contexts.slice(0, 4).map((context) => (
          <div
            ...
            className="needt-panel-depth rounded-md border border-[var(--border-control)] p-2"
          >

...
| --- | --- | --- | --- | --- | --- |
| First-run wizard + seed content | Makes an empty product immediately useful | High after RC | Stable golden loop | M | New account reaches a populated Today view |
...
| PWA performance pass | Improves native feel | Medium | RC golden loop | M | 375px installed-PWA smoke has no jank/overflow |
...
- More design-pass experiments — reconsider after the RC is tagged.
